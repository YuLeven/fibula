defmodule FibulaSiteWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FibulaSiteWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FibulaSiteWeb.Gettext, "errors", msg, opts)
    end
  end
